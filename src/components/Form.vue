<template>
    <div>
        ...
        <div>
            <form id="form" @submit="createPizza">
                ...
                <div class="input-container">
                    <label for="tamanho">Escolha o sabor</label>
                    <select name="tamanho" id="tamanho" v-model="sabor">
                ...
                <div class="input-container">
                    <input type="submit" class="submit-btn" value="Finalizar">
                </div>
            </form>
        </div>
    </div>
